...
function makeOne() {
	let button = document.getElementById('practicum');
...
function makeTwo() {
	let helloWorld = document.getElementById('practicum2');
...
function makeThree() {
	let headTitle = document.querySelector('#practicum3');
    headTitle.innerText = 'Заголовок изменен!';
}
...
function makeFive() {
	let practicum5 = document.getElementById('practicum5');
...
function makeSix() {
	let imgNew = document.getElementById('practicum6');
	imgNew.src = 'newimage.jpg';
	imgNew.alt = 'Новое изображение';
}
...
function makeSeven() {
	let a = document.querySelector('#practicum7');
...
function makeEight() {
	let findUl = document.getElementById('practicum8');
    let addLi = document.createElement('li');
    addLi.textContent = 'Новый элемент';
    findUl.append(addLi);
}
...
function makeNine() {
    let findSelect = document.getElementById('practicum9');
    let createOption = document.createElement('option');
    createOption.textContent = 'Новый вариант';
    findSelect.append(createOption);
}
...
function makeTwelve() {
    let toggleDiv = document.querySelector('#practicum12');
    toggleDiv.classList.toggle('resizeable');
	toggleDiv.style.height = "200px";
    toggleDiv.style.width = "400px";
    toggleDiv.classList.toggle('pr');
}
...
function makeThirteen() {
	let findOl = document.getElementsByTagName('ol')[0];
    findOl.textContent = 'Первый!';
}
...
function makeFourteen() {
	let findAllP = document.querySelectorAll('p');
    //Найдите все элементы <p>
	const paragraphs = findAllP;
...
function makeFifteen() {
	let removeClass = document.getElementById('practicum15');
    removeClass.classList.remove('practicum15');
}
...
function makeSixteen() {
	let addClass = document.getElementById('practicum16');
...
function makeSeventeen() {
	let changeColor = document.getElementById('practicum17');
...
function makeEighteen() {
	let addActive = document.getElementById('practicum18');
...
function makeNineteen() {
	let removeActive = document.getElementById('practicum19');
...
function makeTwenty() {
	let parentDiv = document.getElementById('practicum20');
    let addNewElem = document.createElement('p');
    addNewElem.textContent = 'Добавлено в начало';
    parentDiv.prepend(addNewElem);
}
...
function makeTwentyOne() {
	let parentElem = document.getElementById('practicum21');
    let newElem = document.createElement('p');
    newElem.textContent = 'Добавлено в конец';
...
function makeTwentyTwo() {
    let findImg = document.getElementById('practicum22');
    let f = findImg.hasAttribute('src');
    let result22 = document.getElementById('result22');
    result22.textContent = 'Атрибут "src" присутствует: ' + f;
...
function makeTwentyThree() {
	let findA = document.getElementById('practicum23');
    findA.removeAttribute('href');
}
...
function makeTwentyFour() {
	let findInput = document.getElementById('practicum24');
    findInput.setAttribute('value', 'Новое значение');
}
...
function makeTwentyFive() {
    let findDivAgain = document.getElementById('practicum25');
    findDivAgain.setAttribute('data-info', 'Дополнительная информация');
    let x = 'Дополнительная информация';
    findDivAgain.textContent = 'Добавленный атрибут: ' + x;
	//1 шаг: Найдите элемент
...
function makeTwentySeven() {
    let checkDiv = document.getElementById('practicum27');
    //console.log(checkDiv.classList.contains('.highlight'));
    let b = checkDiv.classList.contains('.highlight');
    checkDiv.textContent = 'False';
	//Найдите переменную
...
let inputChange = document.getElementById('input29');
inputChange.addEventListener('change', handleChange);
...
let divMouseover = document.getElementById('div30');
