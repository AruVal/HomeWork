...
function greetUser(guestName = "Гость") {
	greetUser = "Привет" + ", " + guestName + "!";
...
function calculateAge(currentYear, friendYearOfBirth) {
	return currentYear - friendYearOfBirth
};
console.log("Возраст пользователя: " + calculateAge());
//console.log("Возраст пользователя: " + calculateAge(2023,1985));
...
let myAge = (currentYear, yearOfMyBirth) => (currentYear - yearOfMyBirth);
console.log("Мой возраст: " + myAge(2023,1994));
...
let exponentNum = (c,d) => (c ** d);
console.log("Результат: " + exponentNum(2,5));